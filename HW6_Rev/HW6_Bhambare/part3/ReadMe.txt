...
2. Compilation - icpc -openmp main_03.cpp 

3. Number of processors - Provided in pbs2.sh script file

4. Execution - qsub pbs2.sh
...
13. Banded matrix approach is used in solving. At each SOR iteration TH number of threads are assigned to number of processors provide in the script file.

14. In SOR red/black method was used to solve the banded matrices.  
